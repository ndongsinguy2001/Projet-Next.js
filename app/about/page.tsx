        ...
        <div className="bg-gray-50 rounded-lg p-8 mb-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-gray-600">Développement Web Full Stack à GOMYCODE Sénégal</p>
            </div>
            <div>
              <h3 className="text-xl font-semibold text-gray-800">Compétences principales</h3>
              <p className="text-gray-600">React, Next.js, Node.js, MongoDB, Express, Tailwind CSS</p>
            </div>
          </div>
        </div>
